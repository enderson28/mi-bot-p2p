...
def comando_comandos(bot, message):
    ...
    texto = (
        ...
        f"───────────────\n"
        f"▫️ <code>/p_bdv</code> {e('FLECHA_DERECHA', '❇️')}  {e('BINANCE_ESPEJO', '❇️')} Monitor P2P completo {e('bdv1', '❇️')} por rangos.\n"
        f"───────────────\n"
        ...
        f"───────────────\n"
        f"Uso directo de sus 10 botones ( 5 Vip y 5 libres )en el chat interno del bot.\n\n"
